...
func BenchmarkBulkUpdateWithJson(b *testing.B) {
	b.StopTimer()
	...
	tests := []struct {
	...
	}{
		{
			...
			input: input{path: "/update/", contentType: "application/json",
				payload: "[{\"id\":\"TotalAlloc\",\"value\":323648,\"type\":\"gauge\"},{\"id\":\"PollCount\",\"delta\":10,\"type\":\"counter\"}," +
					"{\"id\":\"TotalAlloc\",\"value\":323648,\"type\":\"gauge\"},{\"id\":\"PollCount\",\"delta\":10,\"type\":\"counter\"}",
			},
		},
	}
