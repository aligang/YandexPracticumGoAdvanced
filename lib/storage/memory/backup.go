...
// BackupConfig for in-memory storage
...
// BackupDo backup in-memory database to file
...
// ConfigureBackup apply backup configuration
...
// Restore in-memory database from file
