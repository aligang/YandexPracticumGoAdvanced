...
// FetchRecord get particular metric from SQL repository
...
// FetchRecords get all records from SQL repository
...
// InsertRecord add single record to SQL repository
...
// InsertRecords add multiple records to SQL repository
...
// UpdateRecord update single record to SQL repository
...
// UpdateRecords update multiple records to SQL repository
